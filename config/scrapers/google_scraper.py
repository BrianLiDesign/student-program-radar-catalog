    ...
    def parse_program_page(self, url: str) -> Optional[dict]:
        ...
        try:
            ...
            if title_elem:
                ...
                if (
                    "student ambassador" not in program_data["name"].lower()
                    and "ambassador" not in program_data["name"].lower()
                ):
            ...
            if main_content:
                ...
                if first_p:
                    ...
                    program_data["short_description"] = (
                        "Google Student Ambassadors help grow Google's presence on campus by hosting events and sharing Google products."
                    )
            else:
                program_data["short_description"] = (
                    "Google Student Ambassadors help grow Google's presence on campus by hosting events and sharing Google products."
            ...
            program_data["perks_detail"] = (
                "Stipend, Google merchandise, access to Google events, networking opportunities, professional development"
            )
            ...
            program_data["source_snippet"] = (
                "Google Student Ambassadors are students who represent Google on their college or university campuses."
            )
            program_data["school_restricted"] = False
            program_data["notes"] = (
                "Program structure and availability may vary by region and academic year"
            )
