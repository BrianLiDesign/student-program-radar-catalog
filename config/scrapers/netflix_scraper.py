        ...
        try:
            ...
            if intro_elem:
                ...
                program_data["short_description"] = (
                    "Netflix Campus Ambassadors help promote Netflix culture and content on college campuses."
                )
            ...
            program_data["perks_detail"] = (
                "Stipend, Netflix subscription, merchandise, invitations to Netflix events"
            )
            ...
            program_data["source_snippet"] = (
                "Netflix Campus Ambassadors are students who represent Netflix on their college or university campuses."
            )
            program_data["school_restricted"] = False
            program_data["notes"] = (
                "Netflix Early Talent programs vary by region and academic focus"
            )
